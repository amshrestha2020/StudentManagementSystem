...
class EditResultForm(forms.Form):
    ...
    assignment_marks  =  forms.ChoiceField(label = "Assignment Marks", widget = forms.TextInput(attrs={"class": "form-control"}))
    exam_marks        =  forms.ChoiceField(label = "Exam Marks", widget = forms.TextInput(attrs={"class": "form-control"}))